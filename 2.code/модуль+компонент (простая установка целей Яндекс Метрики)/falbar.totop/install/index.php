...
class falbar_totop extends CModule{
	...
	//Добавляем тип инфоблока для Метрики
...
//Получаем ID сайта для создания инфоблока
...
//Создание ифноблока для Метрики
...
$arFields = Array(
  ...
  "NAME" => 'Цели для метрики',
  "CODE" => 'metriks_goals',
  "IBLOCK_TYPE_ID" => 'metriks',
  "SITE_ID" => $arSite['ID'],
  );
  $IDmt = $ib->Add($arFields);
