...
?>
<label class="prettycheckbox" data-bx-user-consent="<?= htmlspecialcharsbx($config) ?>">
    <input type="checkbox" class="prettyCheckable" value="Y" <?= ($arParams['IS_CHECKED'] ? 'checked' : '') ?>
