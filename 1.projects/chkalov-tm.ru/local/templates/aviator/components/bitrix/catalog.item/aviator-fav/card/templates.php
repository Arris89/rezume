...
<div class="img-wrap">
    <a href="<?= $item['DETAIL_PAGE_URL'] ?>" title="<?= $imgTitle ?>"
       data-entity="image-wrapper">
        ...
        <? } elseif ($item['PREVIEW_PICTURE']['SRC'] == '/local/templates/aviator/components/bitrix/catalog.section/aviator/images/no_photo.png') { ?>
            ...
            <img itemprop="image" class="js-gallery-container"
                 src="http://aviator-dev2.dev.d-partners.ru/local/templates/aviator/components/bitrix/catalog.section/aviator/images/no_photo.png">
    ...
    <div class="shadow">
        ...
        <?php if ($item['PROPERTIES']['FAV']['VALUE'] == 1) { ?>
            <div class="left" data-wish="1" data-item="<?= $item['ID'] ?>">
                <img src="/upload/listfav.png" alt="Добавить в избранное" height="27" width="30">
            </div>
        <? } else { ?>
            <div class="left" data-wish="0" data-item="<?= $item['ID'] ?>">
...
<div class="col-select1">
    <div class="aval-colors2 owl-carousel owl-theme owl-loaded owl-drag">
        <? if (isset($morePhotoLinks)) {
            foreach ($morePhotoLinks as $link) {
                ?>
                <div class="item">
                    <a rel="prod-gallery-<?= $item['ID'] ?>" class="js-gallery-image" rev="<?= $link ?>"
                       href="/wa-data/public/shop/products/54/09/954/images/2045/2045.0x3000.jpg">
