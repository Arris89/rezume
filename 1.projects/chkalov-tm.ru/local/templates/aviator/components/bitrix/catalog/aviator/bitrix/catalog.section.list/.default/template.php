...
<?
/*echo '<pre>';
print_r( $arResult['SECTIONS']['DESCRIPTION']);
echo '<pre>';*/
?>

<div class="container catalog-list-container">
    <div class="row">
        ...
        case 'TILE':
            ...
            foreach ($arResult['SECTIONS'] as &$arSection)
            {
                ...
                <div class="col-12 col-sm-6 col-md-3 catalog-section-block">
                    <a href="<? echo $arSection['SECTION_PAGE_URL']; ?>" class="catalog-block-link">
                        <div class="catalog-img-wrapper">
                            <img src="<? echo $arSection['PICTURE']['SRC']; ?>" />
                        </div>
                        <div class="catalog-section-content">
                            <span class="catalog-block-heading">
                                <?=$arSection["NAME"]?>
                            </span>
                            <span class="catalog-block-subheading">
                                <? echo TruncateText($arSection['DESCRIPTION'], 40);
                                ?>
                            </span>
                        </div>
                    </a>
