	...
	<div class="" data-entity="basket-checkout-aligner">
				...
				<!--	<div class="basket-coupon-block-field-description">
					...
					<!--<div class="form">-->
						<!--<div class="form-group" style="position: relative;">-->
							<input type="text" class="" id="coup" placeholder="Введите промокод" data-entity="basket-coupon-input">
		...
		<div class="basket-checkout-section">
			...
			<div class="basket-checkout-section-inner">
				...
				<div class="basket-checkout-block basket-checkout-block-total-price" style="display: none">
					<div class="basket-checkout-block-total-price-inner"><!-- БЛОК ЦЕНЫ -->
