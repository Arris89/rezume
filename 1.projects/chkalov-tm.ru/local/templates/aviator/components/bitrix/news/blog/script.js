...
$(function(){
    $(document).ready(function(){
        ...
        document.body.appendChild(s);s.src='/isotope.js';

        console.log('pageload!');

    });
    $(function(){
        /*$('#post-stream .post.blog-item').each(function(i,el){
                var ih = $(el).find('.img-wrap').height()+$(el).find('.info').height();
                console.log(ih);
                //console.log($(el).find('.info').height());
                //if(ih>=657)
                //        $(el).addClass("height1");
                if( (ih < 622) && ( ih >= 541))
                    $(el).addClass("height2");
