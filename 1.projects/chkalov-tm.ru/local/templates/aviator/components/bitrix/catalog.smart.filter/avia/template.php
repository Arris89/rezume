            ...
            <? foreach ($arResult["ITEMS"] as $key => $arItem)//prices
            {
                ...
                if (isset($arItem["PRICE"])):
                    ...
                    <div class="<? if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL"): ?>col-sm-6 col-md-4<?
                        ...
                        <div class="sub-title">Цена</div>

                        <div class="bx-filter-block" data-role="bx_filter_block">
                            <div class="row bx-filter-parameters-box-container">
                                <span class="col-xs-2 bx-filter-parameters-box-container-block bx-left">

                                    <span class="bx-filter-input-container">
                                        <input
                                                class="min-price"
                                                type="text"
                                ...
                                <span class="col-xs-2 bx-filter-parameters-box-container-block bx-right">
                                                ...
                                                if ($ar["CHECKED"]) {
                                                    ...
                                                    <? if (isset($ar["FILE"]) && !empty($ar["FILE"]["SRC"])): ?>
                                                        <span class="bx-filter-btn-color-icon"
                                                              style="background-image:url('<?= $ar["FILE"]["SRC"] ?>');"></span>
                                                    <? endif ?>
                                                    <span class="bx-filter-param-text">2
                                                        <?= $ar["VALUE"] ?>
															</span>
                                                    <?
                                                    $checkedItemExist = true;
                                                        ...
                                                        <label for="<?= $ar["CONTROL_ID"] ?>"
                                                            ...
                                                            <? if (isset($ar["FILE"]) && !empty($ar["FILE"]["SRC"])): ?>
                                                                <span class="bx-filter-btn-color-icon"
                                                                      style="background-image:url('<?= $ar["FILE"]["SRC"] ?>');"></span>
                                                            <? endif ?>
                                                            <span class="bx-filter-param-text">3
                                                                <?= $ar["VALUE"] ?>
																</span>
                                                        </label>
                                                    </li>
                                ...
                                <div class="radio">
                                    <label class="bx-filter-param-label" for="<? echo "all_" . $arCur["CONTROL_ID"] ?>">
												<span class="bx-filter-input-checkbox">
                                                    ...
                                                    />
													<span class="bx-filter-param-text">4<? echo GetMessage("CT_BCSF_FILTER_ALL"); ?></span>
												</span>
                                    </label>
                                </div>
                                <? foreach ($arItem["VALUES"] as $val => $ar): ?>
                        ...
                        ?>
                            ...
                            <div class="size-list">
                                ...
                                foreach ($arItem["VALUES"] as $val => $ar):
                                    ...
                                    if ($ar['CONTROL_NAME_ALT'] == arrFilter_62) {
                                        ...
                                        <label class="label-check option">
                                            ...
                                            />
                                            <span class="label-check__new-input"><?= $ar['VALUE'] ?></span>
                                        </label>
                                        ...
                                        <div style="display: inline-block; width: 50px;">
                                            <label class="js-color-filter option">
                                                <input
                                                        type="checkbox"
                                                        value="<? echo $ar["HTML_VALUE"] ?>"
                                                        name="<? echo $ar["CONTROL_NAME"] ?>"
                                                    ...
                                                    <? echo $ar["CHECKED"] ? 'checked="checked"' : '' ?>
                                                        onclick="smartFilter.click(this)"
                                                        class="js-color-filter-input"
                                                />

                                                <span class="label-check__new-inputt" style="">
                                               <span style=" background-color: #<?= $ColorList[$ar['VALUE']] ?>;
                                                       width: 30px;
                                                       height: 30px;
                                                       display: block;
                                                       margin: auto;
                                                       margin-top: 2px;" title="<?= $ar['VALUE'] ?>"></span>
                                            </label>
                                        </div>
                            ...
                            <div class="size-list js-color-list">
                            ...
                            <style>
                                ...
                                /*СТИЛИ ДЛЯ ЦВЕТОВ В ФИЛЬТРЕ*/

                                .js-color-filter-input {
                                    display: none;
                                }

                                /* Новый чекбокс */
                                .label-check__new-inputt {

                                }

                                /* Новый чекбокс при выборе */
                                .js-color-filter-input:checked + .label-check__new-inputt {
