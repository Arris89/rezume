                    ...
                    case 2:
                        ...
                        foreach ($rowItems as $item) {
                            ...
                            <div class="item" item-id="<?= $item['ID'] ?>">
                                ...
                                ?>
                                <div class="delete" data-item="<?= $item['ID'] ?>"><a href="#"><img
                                                src="<?= SITE_TEMPLATE_PATH ?>/images/basket-delete.jpg" alt=""
                                                height="48" width="46"></a></div>
                            </div>
                            <?
...
//Замена значения счетчика в шапке
                    ...
                    if (fol > 0) {
                        ...
                        var str1 = '<div id="favourite-count" data-count="' + fol + '">' + fol + '</div>';
                        $('.favhead').prepend(str1);
                    }
                    else {

                        var str1 = '<div id="favourite-count" data-count="0">0</div>';
                        $('.favhead').prepend(str1);
                    }
                ...
                function addFavorite(favorID) {
                    ...
                    var param = favorID;
                    $.post('/ajax/favorites.php', {param, idfav}, function (datad) {
