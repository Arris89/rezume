...
<section class="offers section fadeInUp-scroll">
    <div class="wrapper">
        <h2>Вам могут быть интересны</h2>
        <div class="offers__row">
            <div class="offers__slick">
                            ...
                            <div class="card__coll card__coll_items">
                                <div class="chars">
                                    ...
                                    while ($obRes = $res->GetNextElement()) {
                                        $ar_res = $obRes->GetProperty("ARGRUZ");
                                        if (!$ar_res['VALUE'] == 0) { ?>
                                                ...
                                                <div class="chars__title">
                                                    <div class="chars__img">
                                                        <svg width="23px" height="23px" viewBox="0 0 23 23"
                                                            ...
                                                            <g id="1920" stroke="none" stroke-width="1" fill="none"
                                                               fill-rule="evenodd">
                                                                <g id="от-1920-деталка-чем-перевозим-автоспец"
                                                                   transform="translate(-110.000000, -448.000000)"
                                    ...
                                    $res = CIBlockElement::GetByID($arItem['ID']);
                                    while ($obRes = $res->GetNextElement()) {
                                        $ar_res = $obRes->GetProperty("AROBEM");
                                        if (!$ar_res['VALUE'] == 0) { ?>
                                            <div class="chars__item">
                                                <div class="chars__title">
                                                    <div class="chars__img">
                                                        <svg width="22px" height="24px" viewBox="0 0 22 24"
                                                            ...
                                                            <g id="1920" stroke="none" stroke-width="1" fill="none"
                                                               fill-rule="evenodd">
                                                                <g id="от-1920-деталка-чем-перевозим-автоспец"
                                                                   transform="translate(-111.000000, -494.000000)"
                                                                   fill="#818181" fill-rule="nonzero">
                                                                    <g id="Stacked-Group"
                                                                       transform="translate(-1.000000, 0.000000)">
                                                                        <g id="верх"
                                ...
                                <div class="card__items">
                                    <a href="#" id="ar_interes" class="btn btn-truck" value="<?= $arItem['NAME'] ?>">Заказать</a>
            ...
            <div class="box__arrow box__arrow_left">
                <div class="arrow arrow-prev"></div>
            </div>
            <div class="box__arrow box__arrow_right">
