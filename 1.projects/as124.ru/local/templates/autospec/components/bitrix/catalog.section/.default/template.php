...
?>
	...
	if (!empty($arResult['ITEMS']) && !empty($arResult['ITEM_ROWS']))
	{
    	...
    	<div class="card fadeInUp-scroll">
						...
						<a href="<?=$item['DETAIL_PAGE_URL']?>"><div class="card__caption"><?=$item['NAME']?> </div></a>


						<div class="card__row">


							<a href="<?=$item['DETAIL_PAGE_URL']?>" class="card__img">
							...
							<div class="card__coll">
								<div class="chars">
                                    ...
                                    <?php if ($item['DISPLAY_PROPERTIES']['ARMASSA']['VALUE']) { ?>  
								    <div class="chars__item">
								        <div class="chars__title chars__title_items">
								            <div class="chars__name">Масса</div>
								        </div>

								        <div class="chars__value"><?=$item['DISPLAY_PROPERTIES']['ARMASSA']['VALUE']?> т</div>
								    </div>
                                   <? } ?>
                                  <?php if ($item['DISPLAY_PROPERTIES']['ARKOVSH']['VALUE']) { ?>  
								    <div class="chars__item">
								        <div class="chars__title chars__title_items">
								            <div class="chars__name">Объем ковша</div>
								        </div>
								        <div class="chars__value"><?=$item['DISPLAY_PROPERTIES']['ARKOVSH']['VALUE']?> м3</div>
								    </div>
                                   <? } ?>
                                  <?php if ($item['DISPLAY_PROPERTIES']['ARSPEEDPOV']['VALUE']) { ?>  
								    <div class="chars__item">
								        <div class="chars__title chars__title_items">
								            <div class="chars__name">Скорость вращения поворотного мотора</div>
								        </div>
								        <div class="chars__value"><?=$item['DISPLAY_PROPERTIES']['ARSPEEDPOV']['VALUE']?> м</div>
								    </div>
                                     <? } ?>

								</div>
								<div class="card__items">
									<a href="#" id="ar_list" class="btn btn-special" value="<?=$item['NAME']?>">Заказать</a>
									<div class="card__price">от <?=$item['PREVIEW_TEXT']?> руб./ч</div>
								</div>
    ...
    <div class="box-modal" id="modal-special-equipment">
		<div class="modal-content">
			<div class="arcticmodal__window">
				<div class="modal__title">Заказ спецтехники1</div>
