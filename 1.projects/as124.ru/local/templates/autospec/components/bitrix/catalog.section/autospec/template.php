                        ...
                        <div class="page-card__row">
                            ...
                            foreach ($rowItems as $item) {
                                ...
                                <div class="card fadeInUp-scroll">
                                    ...
                                    <div class="card__caption"><?= $item['NAME'] ?> </div>
                                    ...
                                    <div class="card__row">
                                        ...
                                        <div class="card__coll">
                                            <div class="chars">
                                                ...
                                                <?php if ($item['DISPLAY_PROPERTIES']['ARMASSA']['VALUE']) { ?>
                                                    <div class="chars__item">
                                                        ...
                                                        <div class="chars__value"><?= $item['DISPLAY_PROPERTIES']['ARMASSA']['VALUE'] ?>
                                                            т
                                                        </div>
                                                    </div>
                                                <?
                                                ...
                                                <?php if ($item['DISPLAY_PROPERTIES']['ARKOVSH']['VALUE']) { ?>
                                                    <div class="chars__item">
                                                        ...
                                                        <div class="chars__value"><?= $item['DISPLAY_PROPERTIES']['ARKOVSH']['VALUE'] ?>
                                                            м3
                                                        </div>
                                                    </div>
                                                <?
                                                ...
                                                <?php if ($item['DISPLAY_PROPERTIES']['ARSPEEDPOV']['VALUE']) { ?>
                                                    <div class="chars__item">
                                                        <div class="chars__title chars__title_items">
                                                            <div class="chars__name">Скорость вращения поворотного
                                                                мотора
                                                            </div>
                                                        </div>
                                                        <div class="chars__value"><?= $item['DISPLAY_PROPERTIES']['ARSPEEDPOV']['VALUE'] ?>
                                                            м
                                                        </div>
                                                    </div>
                                                <?
                                            ...
                                            <div class="card__desc">Точную стоимость уточняйте у менеджера.<br> Возможны
