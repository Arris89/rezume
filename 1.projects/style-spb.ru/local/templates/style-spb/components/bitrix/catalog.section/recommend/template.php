        ...
        <div class="block_content">
            <div class="bx-wrapper">
                            ...
                            foreach ($arResult['ITEM_ROWS'] as $rowData) {
                                ...
                                <div class="row <?= $rowData['CLASS'] ?>" data-entity="items-row">
                                    ...
                                    switch ($rowData['VARIANT']) {
                                        case 0:
                                            ?>
                                            <div class="col-xs-12 product-item-small-card">1
                                                <div class="row">
                                        ...
                                        case 1:
                                            ?>
                                            <div class="col-xs-12 product-item-small-card">2
                                                <div class="row">
                                                    <?
                                        ...
                                        case 2:
                                            ?>
                                            <div class="col-xs-12 product-item-small-card">3
                                                <div class="row">
                                                    <?
                                                    foreach ($rowItems as $item) {
                                                        ?>
                                        ...
                                        case 6:
                                            ?>
                                            <div class="col-xs-12 product-item-small-card">5
                                                <div class="row">
                                                    <?
                                                    foreach ($rowItems as $item) {
                                                        ?>
                ...
                <div class="bx-controls bx-has-controls-direction">
                    <div class="bx-controls-direction"><a class="bx-prev disabled" href=""></a><a
                                class="bx-next disabled" href=""></a></div>
                </div>
            </div>
        </div>
    </div>
