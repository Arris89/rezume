...
<div class="bx-subscribe" id="sender-subscribe">
    ...
    <form id="bx_subscribe_subform_<?= $buttonId ?>" role="form" method="post" action="<?= $arResult["FORM_ACTION"] ?>">
        <div class="form-group">
            ...
            <input class="inputNew form-control grey newsletter-input" type="email" name="SENDER_SUBSCRIBE_EMAIL"
                   value="Введите ваш e-mail" title="<?= GetMessage("subscr_form_email_title") ?>"
                   placeholder="<?= htmlspecialcharsbx(GetMessage('subscr_form_email_title')) ?>">

            <button type="submit" name="submitNewsletter"
                    class="btn btn-default button button-small" id="bx_subscribe_btn_<?= $buttonId ?>">
                <span>OK</span>
            </button>
        </div>
    </form>
