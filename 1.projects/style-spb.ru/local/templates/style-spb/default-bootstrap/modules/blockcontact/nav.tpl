...
{if $telnumber}
	<span class="shop-phone{if isset($is_logged) && $is_logged} is_logged{/if}">
		<!--<i class="icon-phone"></i>{l s='Call us now:' mod='blockcontact'} <strong>{* $telnumber *}СПб <a href="tel:88126771386" style="color:#fff">8 (812) 677 13 86</a>, РФ <a href="tel:88005050517" style="color:#fff">8 (800) 505 05 17</a>, с 10:00 до 18:00</strong>-->
	</span>
{/if}
