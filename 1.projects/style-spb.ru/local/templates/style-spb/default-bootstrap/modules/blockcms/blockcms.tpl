...
{else}
	...
	<section class="footer-block col-xs-12 col-sm-2" id="block_various_links_footer">
		<div class="h4">{l s='Information' mod='blockcms'}</div>
		<ul class="toggle-footer">
			...
			{/if}
			<li>
				<a href="/content/9-order-process">Как купить</a>
			</li>
			<li>
				<a href="/content/11-for-retailers">Оптовикам</a>
			</li>
		</ul>
		{$footer_text}
	</section>
 ...
 <!--noindex-->Запрещено использование материалов сайта без согласия автора и обратной ссылки.<!--/noindex-->
		</div>
	</section>
	{/if}
	<!-- /Block CMS module footer -->
