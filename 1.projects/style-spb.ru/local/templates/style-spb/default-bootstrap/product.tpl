...
<div itemscope itemtype="https://schema.org/Product">
	...
	<div class="primary_block row">
		...
		<div class="pb-center-column col-xs-12 col-sm-4">
			...
			{/if}
			<h1 itemprop="name">{$product->name|escape:'html':'UTF-8'} ({$product->reference|escape:'html':'UTF-8'})</h1>
			...
			{if isset($product) && $product->description}
				...
				<section class="page-product-box">
					<div class="h3 page-product-heading">{l s='More info'}</div>
					<!-- full description -->
...
{if (isset($quantity_discounts) && count($quantity_discounts) > 0)}
			<!-- quantity discount -->
			<section class="page-product-box">
				<div class="h3 page-product-heading">{l s='Volume discounts'}</div>
		...
		{if isset($features) && $features}
			<!-- Data sheet -->
			<section class="page-product-box">
				<div class="h3 page-product-heading">{l s='Data sheet'}</div>
		...
		<section id="blockpack">
			<div class="h3 page-product-heading">{l s='Pack content'}</div>
		...
		{if isset($accessories) && $accessories}
			<!--Accessories -->
			<section class="page-product-box">
				<div class="h3 page-product-heading">{l s='Accessories'}</div>
		...
		{if (isset($product) && $product->description) || (isset($features) && $features) || (isset($accessories) && $accessories) || (isset($HOOK_PRODUCT_TAB) && $HOOK_PRODUCT_TAB) || (isset($attachments) && $attachments) || isset($product) && $product->customizable}
			...
			<!--Download -->
			<section class="page-product-box">
				<div class="h3 page-product-heading">{l s='Download'}</div>
			...
			<!--Customization -->
			<section class="page-product-box">
				<div class="h3 page-product-heading">{l s='Product customization'}</div>
