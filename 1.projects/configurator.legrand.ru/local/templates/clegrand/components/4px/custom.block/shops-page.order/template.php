    ...
    <div class="section-r-order__container container">
        <div class="basket">
            <div class="basket__head">
                <h1 class="basket__title page-title">Способы получения заказа
                </h1>
                <div class="basket__nav">
                    <div class="basket-nav">
                        <div class="basket-nav__list"><a class="basket-nav__item" href="<?=$arParams['PARAMS_JSON']['arParams']['PATH_TO_BASKET']?>"><span class="basket-nav__icon">
