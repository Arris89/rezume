...
console.log(total);
  ...
  var removeItem = function removeItem(index) {
    ...
    if(items.length == 0)
    {
      $('.specification__refresh').css('display','none');

      /*деактивация кнопки Добавить в избранное*/
      $('.basket-kit-bottom__later').attr("id", "");
      $('#popdef').attr("href", "");

       /*деактивация кнопки Добавить в корзину*/
      $('.basket-kit__add').attr("id", "");
      $('#popbask').attr("href", "");
    }
  };
...
$('.specification__refresh').css('display','none');
 ...
 /*деактивация кнопки Добавить в корзину*/
  ...
  var renderView = function renderView() {
    ...
    {
       /*активация кнопки Добавить в избранное*/
       $('.basket-kit-bottom__later').attr("id", "deferred");
       $('#popdef').attr("href", "#popup-deferred");

         /*активация кнопки Добавить в корзину*/
       $('.basket-kit__add').attr("id", "bask");
       $('#popbask').attr("href", "#popup-specification");
    }

if(total)
{
  $('.specification__refresh').css('display','block');
}
  ...
  $('body').on('click', '.btn-add-spec-js', function () {
    ...
    var data = {
      ...
      modal: itemBlock.data('modal'),
      color: itemBlock.data('color'),
...
function declOfNum(number, titles) {  
  ...
  $('body').on('click', '#bask', function (event) {
  ...
  $('body').on('click', '#deferred', function (event) {
    event.preventDefault();
