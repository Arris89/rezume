...
<div class="catalog-main__inner catalog-main__inner_filters filters">
    <button class="filters__toggle" type="button">Фильтры</button>
    <div class="filters__inner">


        <form name="<? echo $arResult["FILTER_NAME"] . "_form" ?>" action="<? echo $arResult["FORM_ACTION"] ?>"
              method="get" class="filters__form filters-form">
            ...
            <div class="filters-form__item filter filter_colors">
                <?
                }
                else{
                ?>
                <div class="filters-form__item filter">
                    <?
                    } ?>


                    <div class="<? if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL"): ?><? endif ?> bx-filter-parameters-box <? if ($arItem["DISPLAY_EXPANDED"] == "Y"): ?>bx-active<? endif ?>">

                        <button class="filter__toggle" type="button"><?= $arItem["NAME"] ?></button>
                        <div class="filter__content">
                            ...
                            ?>
                                <div class="col-xs-12">
                                    <div class="bx-filter-parameters-box-container-block">2
                                    ...
                                    <div class="bx-filter-parameters-box-container-block">3
                                        <div class="bx-filter-input-container bx-filter-calendar-container">
                                            <? $APPLICATION->IncludeComponent(
                                                'bitrix:main.calendar',
                                                '',
                            ...
                            if (CModule::IncludeModule('highloadblock')) {
                                ...
                                $result = $entity_data_class::getList(array(
                                    "select" => array("UF_NAME", "UF_DESCRIPTION"), // Поля для выборки
                                    "order" => array(),
                                    "filter" => array(),
                                ));

                                while ($resds = $result->fetch()) {
                                    $ColorList[$resds["UF_NAME"]] = $resds["UF_DESCRIPTION"];
                                }
                            } ?>
                            ...
                            <? if ($arItem['NAME'] == 'Цвет') { ?>
                                ...
                                <div class="filter__inner" style="display: flex;">
                                <?
                            } ?>
                                ...
                                <? if ($ar['CONTROL_NAME_ALT'] == arrFilter_18) {
                                    ?>
                                    <div class="filter__item">
                                        <input class="filter__checkbox" type="checkbox" type="checkbox"
                                        ...
                                        <label class="filter__label"
                                               style="background-color:#<?= $ColorList[$ar['VALUE']] ?>"
                                    ...
                                    <div class="filter__item">
                                        ...
                                        />
                                        <label data-role="label_<?= $ar["CONTROL_ID"] ?>" class="filter__label"
                                               for="<? echo $ar["CONTROL_ID"] ?>">
                                            <?= $ar["VALUE"]; ?><?
                                            if ($arParams["DISPLAY_ELEMENT_COUNT"] !== "N" && isset($ar["ELEMENT_COUNT"])):
                                                ?>(<span
                ...
                <div class="filters-form__btn-area">
                    <input
                            class="filters-form__btn filters-form__btn_submit btn"
                            type="submit"
                            id="set_filter"
                            name="set_filter"
                    ...
                    />
                    <input
                            class="filters-form__btn filters-form__btn_reset btn btn_type_link"
                            type="submit"
                            id="del_filter"
                            name="del_filter"
