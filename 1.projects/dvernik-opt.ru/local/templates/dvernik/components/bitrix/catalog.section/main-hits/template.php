			...
			?>
				...
				switch ($rowData['VARIANT'])
				{
					...
					case 1:
						...
						<div class="col-xs-12 product-item-small-card">
							<div class="row">
								...
								{
									?>
									<div class="col-xs-6 product-item-big-card">2
										<div class="row">
											<div class="col-md-12">
												<?
												$APPLICATION->IncludeComponent(
					...
					case 2:
						...
						<div class="col-xs-12 product-item-small-card">
							<div class="row">
								...
								{
									?>
									<div class="col-sm-4 product-item-big-card">3
										<div class="row">
											<div class="col-md-12">
												<?
												$APPLICATION->IncludeComponent(
					...
					case 4:
						...
						?>
						<div class="col-sm-6 product-item-big-card">4
							<div class="row">
								<div class="col-md-12">
									<?
					...
					case 5:
						...
						<div class="col-sm-6 product-item-big-card">5
							<div class="row">
								<div class="col-md-12">
									<?
									$item = end($rowItems);
					...
					case 7:
						$rowItemsCount = count($rowItems);
						?>
						<div class="col-sm-6 product-item-big-card">6
							<div class="row">
								<div class="col-md-12">
									<?
									$item = array_shift($rowItems);
					...
					case 8:
						...
						<div class="col-sm-6 product-item-big-card">7
							<div class="row">
								<div class="col-md-12">
									<?
									$item = end($rowItems);
