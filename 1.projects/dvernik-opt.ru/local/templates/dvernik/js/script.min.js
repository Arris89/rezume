...
$(function () {
    ...
    var a = function () {
        var e = $(".main-header__btn"), n = $(window).width();
    ...
    var e = $(".sorting-area__select"), n = $(".view-controls__select");
    ...
    i.length && i.on("click", function (e) {
        var n = $(e.currentTarget), t = n.parent(), a = n.siblings();
    ...
    if (e = window.navigator.userAgent, 0 < (0 < (n = e.indexOf("MSIE")) ? parseInt(e.substring(n + 5, e.indexOf(".", n))) : navigator.userAgent.match(/Trident\/7\./) ? 11 : void 0)) {
        var t = "js/plugins/svgxuse/svgxuse.min.js", a = function (e) {
            $("<script>", {src: e}).appendTo(document.body)
        };
    ...
    $(".faq__item").length && $(".faq__name").on("click", function (e) {
        e.preventDefault();
        var n = $(e.currentTarget), t = n.next(".faq__inner");
    ...
    var n = {
        rules: {
            "user-name": {required: !0, minlength: 2},
            "user-email": {required: !0, email: !0},
            "user-tel": {required: !0, minlength: 10}
        },
        messages: {
            "user-email": "Введите корректный email",
            "user-tel": {required: "Введите телефон", minlength: "Телефон должен содержать минимум 10 цифр"}
        }
    };
...
/*    $('input[type="submit"]').on("click", function (e) {
        e.preventDefault(), function (e) {
            if (e.valid()) {
                var n = $(e).find('[name="user-name"]').val() || "none",
                    t = $(e).find('[name="user-email"]').val() || "none", a = $(e).find('[name="user-tel"]').val();
                $.ajax({
                    type: "POST",
                    url: "https://example.com",
                    async: !0,
                    dataType: "json",
                    data: {name: n, email: t, phone: a}
                }).done(function (e) {
                    console.log(e)
                }).fail(function (e) {
                    console.log(e)
    ...
    var e = $(".item-thumb");
    e && e.hover(function () {
        $(this).closest(".slider").find(".slider__pagination").css({"z-index": "-1"})
    }, function () {
        $(this).closest(".slider").find(".slider__pagination").css({"z-index": "0"})
    })
}), $(function () {
    var i = $("#map");
    if (i.length) {
        ymaps.ready(function () {
            var a, e = {x: i.data("x"), y: i.data("y")},
                n = new ymaps.Map("map", {center: [e.x, e.y], zoom: 5, controls: []});
            if (i.hasClass("map__content_partners")) {
                var t = i.find(".map__pin");
                t.length && (a = n, t.each(function (e, n) {
                    var t = {x: $(n).data("x"), y: $(n).data("y")};
                    a.geoObjects.add(new ymaps.Placemark([t.x, t.y], {}, {preset: "islands#redStarIcon"}))
                }))
            }
            i.hasClass("map__content_main") && (n.setZoom(16), n.geoObjects.add(new ymaps.Placemark([e.x, e.y], {}, {preset: "islands#redHomeIcon"})))
        })
    }
}), $(function () {
    var e = $(".main-header__navigation-area");
    if (e.length) {
        var n = e.find(".main-header__navigation"), t = e.find(".main-header__menu-btn");
    ...
    e.length && e.overlayScrollbars({className: "os-theme-green"})
}), $(function () {
    var e = function (e, n, t) {
        var a = n.find(".slider__list"), i = n.find(".slider__pagination");
    ...
    n.length && e({dots: !0, adaptiveHeight: !0}, n, !0);
    var t = {
        dots: !0,
        arrows: !1,
        slidesToShow: 5,
        ...
        centerMode: !0,
        centerPadding: "15px",
        responsive: [{breakpoint: 1170, settings: {slidesToShow: 3, centerMode: !1}}, {
            breakpoint: 768,
            settings: {slidesToShow: 1, centerMode: !1}
        }]
    }, a = $(".doors_rooms .doors__content_new.slider"), i = $(".doors_rooms .doors__content_hits.slider");
    a.length && e(t, a, !1), i.length && e(t, i, !1);
    var s = $(".doors_main .doors__content_new.slider"), o = $(".doors_main .doors__content_hits.slider");
    ...
    _.length && e({
        ...
        customPaging: function (e, n) {
            return '<button type="button"><img class="slider__img" src="img/item-image-'.concat(n, '.jpg" alt="Входная дверь Металюкс Стандарт М550"></button>')
        }
    }, _, !1)
}), $(function () {
    var e = function (e) {
        $(e).find(".tabs__item").on("click", function (e) {
            var n = e.currentTarget, t = $(n).parent().siblings(".doors__content_new"),
